...
while running:
    ...
    if Background == "StartWeapon":
        ...
        if Gamekind == 0:
            ...
            screen.blit(Asset_dict[f'b049gaming0-21'], (WIDTH/2+WIDTH*0.4*math.sin(Global_Time/FPS),0.7*HEIGHT))
            screen.blit(Asset_dict[f'b049gaming0-22'], (WIDTH/2-WIDTH*0.25*math.sin(Global_Time/FPS),0.65*HEIGHT))
            screen.blit(Asset_dict[f'b049gaming0-23'], (WIDTH/2+WIDTH*0.1*math.cos(Global_Time/FPS),0.6*HEIGHT))
