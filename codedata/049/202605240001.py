...
class roomcenterthing(pygame.sprite.Sprite):
    ...
    def touch(self):
        ...
        if MAP[Pr,Pc] == 3:
            mapused = True
            Anim_Time['AnimRoomCenter3'] = 2 * FPS
        if MAP[Pr,Pc] == 6:
            mapused = True
            Anim_Time['AnimRoomCenter6'] = 2 * FPS
        if MAP[Pr,Pc] == 8:
            mapused = True
...
def Anim_RoomCenter2():
    rec= pygame.Rect(WIDTH / 2, HEIGHT / 2, WIDTH / 120 * (60-Anim_Time['AnimRoomCenter2']), HEIGHT / 90 * (60-Anim_Time['AnimRoomCenter2']))
    rec.center = (WIDTH // 2, HEIGHT // 2)
    pygame.draw.rect(screen, (255, 215, 0), rec, int(max(HEIGHT / 60, 1)))

def Anim_RoomCenter3(): #這裡要改
    rec= pygame.Rect(WIDTH / 2, HEIGHT / 2, WIDTH / 120 * (60-Anim_Time['AnimRoomCenter3']), HEIGHT / 90 * (60-Anim_Time['AnimRoomCenter3']))
    rec.center = (WIDTH // 2, HEIGHT // 2)
    pygame.draw.rect(screen, (0, 0, 255), rec, int(max(HEIGHT / 60, 1)))

def Anim_RoomCenter6(): #這裡要改
    rec= pygame.Rect(WIDTH / 2, HEIGHT / 2, WIDTH / 120 * (60-Anim_Time['AnimRoomCenter6']), HEIGHT / 90 * (60-Anim_Time['AnimRoomCenter6']))
    rec.center = (WIDTH // 2, HEIGHT // 2)
    pygame.draw.rect(screen, (0, 0, 255), rec, int(max(HEIGHT / 60, 1)))

def Anim_RoomCenter8():
    rec= pygame.Rect(WIDTH / 2, HEIGHT / 2, WIDTH / 120 * (60-Anim_Time['AnimRoomCenter8']), HEIGHT / 90 * (60-Anim_Time['AnimRoomCenter8']))
    rec.center = (WIDTH // 2, HEIGHT // 2)
