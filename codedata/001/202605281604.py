...
attackted = True  # 預設為 True，代表還沒擲骰前不能攻擊
#地圖生成
...
def assetsload(WIDTH,HEIGHT):
    ...
    Asset_dict = {
        ...
        "b049gaming0-21":pygame.transform.smoothscale(pygame.image.load(os.path.join("assets","animdict","b049gaming0-2.png")).convert_alpha(), (int(WIDTH/6), int(WIDTH/6))),
        "b049gaming0-22":pygame.transform.smoothscale(pygame.image.load(os.path.join("assets","animdict","b049gaming0-2.png")).convert_alpha(), (int(WIDTH/8), int(WIDTH/8))),
        "b049gaming0-23":pygame.transform.smoothscale(pygame.image.load(os.path.join("assets","animdict","b049gaming0-2.png")).convert_alpha(), (int(WIDTH/10), int(WIDTH/10))),
...
def apply_event_card(event_card):
    ...
    if event_type == "monster_double_attack":
        ...
        battle_message = "事件：此戰 Boss 攻擊不可被 immune"
...
def reset_game():
    ...
    global mango_bonus, next_battle_chengchen, attackted
...
while running:
    ...
    if Background == "StartWeapon":
        ...
        if Gamekind == 0:
            ...
            #screen.blit(Asset_dict[f'b049gaming0-21'], (0.7*HEIGHT))
            #screen.blit(Asset_dict[f'b049gaming0-22'], ())
            #screen.blit(Asset_dict[f'b049gaming0-23'], ())
